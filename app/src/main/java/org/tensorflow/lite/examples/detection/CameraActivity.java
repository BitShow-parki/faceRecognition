...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private static final String PERMISSION_CAMERA = Manifest.permission.CAMERA ,PERMISSION_READ_STORAGE=Manifest.permission.READ_EXTERNAL_STORAGE,PERMISsION_WRITE_STORAGE=Manifest.permission.WRITE_EXTERNAL_STORAGE ;
  ...
  private void requestPermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      ...
      requestPermissions(new String[] {PERMISSION_CAMERA, PERMISSION_READ_STORAGE ,PERMISsION_WRITE_STORAGE}, PERMISSIONS_REQUEST);
    }
  }
